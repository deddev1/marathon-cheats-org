...
const defaultImages: BrandSitemapImage[] = [
	...
	{
		src: '/images/marathon-cheats-run.webp',
		title: 'marathon cheats',
		caption: 'marathon cheats in run',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Marathon', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'marathon-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'marathon-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Marathon on PC' },
