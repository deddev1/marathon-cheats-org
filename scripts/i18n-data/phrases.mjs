...
const KW = {
	...
	cheats: 'marathon cheats',
	hack: 'marathon cheat',
	esp: 'Marathon ESP',
	wallhack: 'ESP wallhack',
	radar: 'radar hack',
	aimbot: 'Marathon Aimbot',
...
export const phrases = {
	es: {
		buy: 'Comprar Marathon Cheats', undetected: 'indetectables', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		s2: () => `Licencias con ${phrases.es.delivery} vía checkout ${KW.checkout}. Planes ${phrases.es.monthly} y ${phrases.es.lifetime} incluyen mantenimiento ${KW.battleye}.`,
		...
		legal: () => 'Contacta support@marathoncheats.org para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Marathon Cheats', undetected: 'indétectables', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'Contactez support@marathoncheats.org pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Marathon Cheats kaufen', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Marathon Cheats', undetected: 'indetectáveis', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'Contacte support@marathoncheats.org para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Marathon Cheats', undetected: 'indetectable', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'Contatta support@marathoncheats.org per supporto o richieste legali.',
	},
	nl: {
		buy: 'Marathon Cheats kopen', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Marathon Cheats', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Marathon Cheats', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Marathon Cheats satın al', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'Destek ve yasal sorular için support@marathoncheats.org.',
	},
	ar: {
		buy: 'اشترِ Marathon Cheats', undetected: 'غير مكتشف', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Marathon Cheatsを購入', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'サポート・法務: support@marathoncheats.org',
	},
	ko: {
		buy: 'Marathon Cheats 구매', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => '지원 및 법무: support@marathoncheats.org',
	},
	zh: {
		buy: '购买 Marathon Cheats', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => '支持与法务：support@marathoncheats.org',
	},
	hi: {
		buy: 'Marathon Cheats खरीदें', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'सहायता: support@marathoncheats.org',
	},
	id: {
		buy: 'Beli Marathon Cheats', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Marathon Cheats', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Marathon Cheats', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Marathon Cheats', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Marathon Cheats', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Marathon Cheats', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		legal: () => 'support@marathoncheats.org pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Marathon Cheats', undetected: 'undetected', maps: 'Tau Ceti IV, outposts, and extraction zones',
		...
		s3: () => `Kontrollera Updates marathoner ${KW.battleye}-patchar. Ingen cheat garanterar permanent undetected status.`,
		legal: () => 'support@marathoncheats.org för support och juridik.',
	},
};
