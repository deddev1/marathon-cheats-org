#!/usr/bin/env node
/**
 * Ports the 8 posts from ../marathon-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'marathon-blog', 'src', 'content', 'posts');
const OUT = join(ROOT, 'src', 'data', 'blog', 'posts.generated.ts');

const CATEGORY_NAMES = {
	'survival-game-meta': 'session Meta',
	'zero-build-strategies': 'loot run',
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'marathon intel'],
...
const file = `/* Auto-generated by scripts/port-from-marathon-blog.mjs — do not edit by hand. */
