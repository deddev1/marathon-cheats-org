#!/usr/bin/env node
/**
 * Generates src/data/blog/posts.generated.ts — NLP-first Marathon Intel posts.
...
const sources = [
	...
	},
	{
		...
		metaDescription:
			'Sensible advice on Marathon cosmetics and skin previews — what to buy on the in-game store, what to skip, and how looks affect run readability.',
		h1: 'Marathon Cosmetics and Skin Previews: Buy Smart, Not Impulsive',
		intro:
			'Leaks make every patch cycle feel like a fashion drop. Before you dump growth points into another loud outfit, decide whether the skin helps you play Marathon — or just looks cool in a screenshot.',
		keywords: [
			'marathon skins',
			'marathon cosmetics',
			'in-game store skins',
		...
		sections: [
			{
				...
				paragraphs: [
					`Shop rotations and official skins come from ${EXT.marathon}. Leaks are entertainment, not a shopping list. Many players spend hard-earned in-game currency the night before a patch cycle, then realize they still need stamina recovery, ammo, and a backup kit.`,
		...
		sections: [
			{
				...
				paragraphs: [
					...
					`Always re-check live values after patches on ${EXT.marathon}. The hierarchy logic stays useful even when numbers nudge.`,
				],
			},
			{
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`Stay close to hard cover while you move — never more than a short sprint from a wall or vehicle. Pressure late rotates near exfil and loot zones when players are silhouetted and greedy. Mode rules evolve with ${EXT.marathon} patch cycles; the geometry of first-shot advantage does not.`,
				],
			},
			{
		...
		sections: [
			{
				...
				paragraphs: [
					`Start with schedules and film from ${EXT.marathon} official updates or trusted creators, then tag habits instead of memorizing a single POI name. Note the landing plan, first heal, first rotate, first voluntary fight, and the key late-session decision.`,
	...
	},
	{
		...
		metaDescription:
			'High-percentage Marathon loot routes for Tau Ceti IV, Woods, and Gateway — how to leave spawn with guns, armor, and stamina recovery that win mid-session fights.',
		h1: 'Marathon Loot Routes: Leave Spawn Ready to Fight',
		intro:
			'Winning in Marathon starts before the first gunfight. Random loot dropsing gets you killed with a pistol and no stamina recovery. These route habits consistently convert a drop into a kit you can actually fight with.',
		keywords: [
			'marathon loot routes',
			'Tau Ceti IV loot routes',
			'Gateway loot spawns',
			'marathon spawn guide',
			'Marathon ESP',
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`Timing targets help: first gun quickly, clear a cluster, grab heals, then upgrade or leave. Slot priority is usually gun, ammo, armor, stamina recovery, then flex loot drops. POI names shift with ${EXT.marathon} patch cycles — keep the geometry, not just the landmark brand.`,
				],
			},
			{
	...
	},
	{
		...
		metaDescription:
			'Practical Marathon settings used by strong players — visibility, audio cues, aim smoothing, and what to copy vs ignore from pro configs.',
		h1: 'Marathon Settings Guide: See More, Panic Less',
		intro:
			'Copying a champion’s entire config will not make you one. But a few Marathon settings reliably improve visibility, audio reads, and aim consistency. Here is what is worth stealing.',
		keywords: [
			'marathon settings',
			'marathon aim smoothing',
			'marathon visibility',
	...
	},
	{
		...
		metaDescription:
			'A short Marathon warmup routine before survival runs — aim, peeks, audio focus, and what to practice offline so your first fight is not your warmup.',
		h1: 'Marathon Warmup Routine Before You Queue player',
		intro:
			'Queuing cold into high-traffic zones or high-traffic zones is how you donate a kit. A short Marathon warmup — even ten to fifteen minutes — makes your first real fight feel like your third.',
		keywords: [
			'marathon warmup',
			'marathon aim practice',
			'survival warmup routine',
			'marathon practice server runs',
			'marathon intel',
		],
	...
	},
	{
		...
		metaDescription:
			'What to check before you buy marathon cheats — status pages, ESP features, soft aim, refunds, pricing, and red flags in 2026.',
		h1: 'Marathon Cheats: What to Check Before You Buy',
		intro:
			'Buying marathon cheats is noisy. Every storefront promises “undetected,” instant delivery, and god mode. This buyers guide slows you down with a practical checklist so you spend money on maintenance and clarity — not banners.',
		keywords: [
			'marathon cheats',
			'marathon cheats buyers guide',
			'buy marathon cheats',
			'undetected marathon cheats',
			'marathon pricing',
		],
	...
	},
	{
		...
		metaDescription:
			'What changed for marathon cheats in 2026 — patch cycle cadence, BattlEye maintenance habits, ESP focus, and how Marathon Cheats adapted for Marathon.',
		h1: 'What Changed for Marathon Cheats in 2026',
		intro:
			'2026 did not invent cheating in Marathon — it raised the bar for maintenance. Wipes, BattlEye pushes, and map updates punish stale builds. Here is what changed in how serious Marathon Cheats packages need to operate.',
		keywords: [
		...
		sections: [
			{
				...
				paragraphs: [
					...
					`${EXT.battleye} and Marathon client updates still force rebuilds. The shops that survive are the ones that communicate during those windows.`,
				],
			},
			{
	...
	},
	{
		...
		metaDescription:
			'What marathon ESP and wallhack actually show in Marathon — players, loot drops, distance, exfils — and how to keep overlays readable in runs.',
		h1: 'Marathon ESP and Wallhack Explained Clearly',
		intro:
			'“ESP” and “wallhack” get used interchangeably. In Marathon they both mean information through walls — but the useful details are distance, filters, and what you choose to hide so your screen stays readable.',
		keywords: [
			'Marathon ESP',
			'marathon wallhack',
			'Marathon ESP',
	...
	},
	{
		...
		h1: 'Undetected Marathon Cheats: What BattlEye Reality Looks Like',
		intro:
		...
		sections: [
			{
				...
				paragraphs: [
					`BattlEye is documented at ${EXT.battleye}. It evolves. Vendors who care publish rebuild notes when ESP, radar, or aim modules need work. Marathon Cheats does that on <a href="/updates/">Updates</a> and explains the workflow on <a href="/battleye-bypass/">BattlEye maintenance</a>.`,
			...
			},
			{
				...
				paragraphs: [
					`After a Marathon or BattlEye update, wait for a status note before dropping in. Confirm Steam services on ${EXT.status} if the launcher itself is failing. Do not run yesterday’s build into today’s anti-cheat and call it bad luck.`,
	...
	},
	{
		...
		metaDescription:
			'How Marathon Cheats compares to typical budget marathon cheat shops — ESP depth, radar, status pages, pricing, and what “cheap” usually skips.',
		h1: 'Marathon Cheats vs Typical Budget Marathon Cheat Shops',
		intro:
			'Budget Marathon stores often look identical: neon banners, “undetected” badges, and a low weekly price. Marathon Cheats costs more than the cheapest tier on purpose. Here is what you usually trade when you chase the lowest sticker.',
		keywords: [
			'marathon cheats comparison',
			'budget marathon cheats',
			'marathon cheats vs other shops',
			'esp radar pricing',
			'marathon cheats',
		],
	...
	},
	{
		...
		metaDescription:
			'A two-week test of another budget marathon cheat before switching to Marathon Cheats — ESP feel, soft aim, patch downtime, and support differences.',
		h1: 'I Tested Another Marathon Cheat for Two Weeks Before Switching',
		intro:
			'My Discord kept recommending a popular budget marathon cheat shop. I gave it fourteen days on the same PC and official servers, then moved to Marathon Cheats. This is what actually differed — without the usual affiliate script.',
		keywords: [
			'marathon cheats review',
			'marathon cheat comparison',
			'marathon cheat downtime',
			'soft aim test',
			'marathon cheats',
		],
	...
	},
	{
		...
		metaDescription:
			'Full-stack Marathon Cheats versus minimal ESP-only Marathon tools — feature depth, radar, soft aim, pricing, and who should buy which style.',
		h1: 'Full-Stack Marathon Cheats vs Minimal ESP-Only Tools',
		intro:
			'Some Marathon tools sell a slim ESP module and call it a day. Marathon Cheats ships the wider run stack. Neither philosophy is automatically wrong — they fit different players. Here is a clear comparison.',
		keywords: [
			'Marathon ESP only cheat',
			'marathon cheats features',
			'radar vs esp',
			'marathon cheat pricing',
			'marathon cheats',
		],
...
function normalizeKeywords(keywords) {
	...
	return keywords
		...
		.filter((k) => {
			...
			if (!k || lower === 'marathon intel' || seen.has(lower)) return false;
			seen.add(lower);
			return true;
		})
		.slice(0, 4);
...
const POST_META = {
	...
	'marathon-esp-wallhack-explained': {
